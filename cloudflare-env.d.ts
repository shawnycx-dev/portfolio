/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 3e57215c55a3c9da6802b7b0421d3a9b)
...
declare namespace Cloudflare {
	interface Env {
		...
		R2: R2Bucket;
		D1: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* shawnycx-portfolio */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "CLOUDFLARE_API_TOKEN" | "download_secret" | "DATABASE_URL" | "RESEND_API_KEY" | "PAYLOAD_SECRET">> {}
}
